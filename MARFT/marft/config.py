...
def get_config():
    ...
    parser.add_argument(
        ...
        help="specify the normalization mode for APPO (use TWOSOME or not).",
    )
    parser.add_argument(
        "--agent_iteration_interval",
        type=int,
        default=0,
        help="the interval of agent iteration. if set 0, train concurrently.",
    )
    parser.add_argument(
        "--experiment_name",
        type=str,
    ...
    parser.add_argument(
        "--horizon", type=int, default=3, help="The horizon of the rollout."
    )

    # env parameters
    parser.add_argument(
        "--env_name", type=str, default="MATH", help="Which env to run on"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="number of warmup steps for the critic",
    )
    parser.add_argument(
        "--hidden_size",
        type=int,
    ...
    # optimizer parameters
    parser.add_argument(
        "--lr", type=float, default=5e-7, help="learning rate (default: 5e-7)"
    )
    parser.add_argument(
        "--critic_lr",
        type=float,
